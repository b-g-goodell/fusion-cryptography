...
def fwd_ntt_api(val: List[int], modulus: int) -> List[int]:
    ...
    halfmod, logmod, degree, root_order, root, brv_root_powers = derived_params(val=val, modulus=modulus, inv_flag=False)
...
def inv_ntt_api(val: List[int], modulus: int) -> List[int]:
    ...
    halfmod, logmod, degree, root_order, inv_root, brv_inv_root_powers = derived_params(val=val, modulus=modulus, inv_flag=True)
